...
OmniShadow::OmniShadow() : Shadow() {}

OmniShadow::~OmniShadow() {}

bool OmniShadow::Init(GLuint w, GLuint h)
{
    shadowWidth = w;
    shadowHeight = h;
...
void OmniShadow::Write()
{
    glBindFramebuffer(GL_DRAW_FRAMEBUFFER, FBO);
}

void OmniShadow::Read(GLuint texUnit)
{
