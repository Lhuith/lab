            ...
            if ((str.find_first_not_of(" \t\r\n") != string::npos) && (str[0] != '#')) {
                ...
                // Note that no transforms/stacks are applied to the colors. 
                    ...
                    if (validinput) {
                        ...
                        cout << "cam> ";
                        cout << "eye: " << values[0] << ", " << values[1] << ", " << values[2] << " ";
                        cout << "up: " << values[3] << ", " << values[4] << ", " << values[5] << " ";
                        cout << "cen: " << values[6] << ", " << values[7] << ", " << values[8] << " ";
                        cout << "fovy: " << values[9];
                        cout << endl;
                ...
                // Also look at demo.txt to get a sense of why things are done this way.
                    ...
                    if (validinput) {
                        ...
                        rightmultiply(
                            Transform::translate(values[0], values[1], values[2]), transfstack);
                        cout << endl;
                    }
                }
                else if (cmd == "scale") {
