...
$(function () {
        ...
        function init()
        {
            //Create Characters (probably stored somewhere but MEH")
           ...
           // test.camera.visible = true;
            ...
            $("#webgl4-container").append(renderer.domElement);
            ...
            $("#webgl4-container").append(stats.domElement);
            var i = 0;
        ...
        function addText()
        {
            textSize = Math.floor((Math.random()) * (4,6));
            textGeo = new THREE.TextGeometry(GenerateWord((Math.random()) * (1,10)), { size: textSize, height: 2 });
            texmat = new THREE.MeshPhongMaterial({ color: Math.random() * 0xff900 });
            text = new THREE.Line(textGeo, texmat);
            text.castShadow = true;
            text.name = "Anus" + scene.children.length;
            ...
            text.rotation.x = Math.floor(Math.random() * 99) - 49;
            text.rotation.y = Math.floor(Math.random() * 99) - 49;
            text.rotation.z = Math.floor(Math.random() * 99) - 49;
        ...
        function deleteText()
        {
            ...
            if (lastTextAdded instanceof THREE.Line)
            {
        ...
        function render()
        {
            scene.traverse(function (value) {
                if (value instanceof THREE.Line)
                {
