/*
    Decision contructs and boolean operators demo
*/
#include <stdio.h>
#include <string.h>
...
int main(int argc, char* argv[]){
    ...
    printf("%d != true ? %s\n", boolValue, boolValue != true ? "true" : "false");
    printf("%d == false ? %s\n", boolValue, boolValue == false ? "true" : "false");    
    printf("%d != false ? %s\n\n", boolValue, boolValue != false ? "true" : "false");
    ...
    switch (argc) {
     ...
     printf("Words in the Argv are :\n");
    for(int i = 1; i < argc; i++){
            printf("%s\n\n", argv[i]);
    }

    
    if(strcmp(argv[1],"ass") == 0) printf("Thats just Nasty!\n");
    /*
    */
}
